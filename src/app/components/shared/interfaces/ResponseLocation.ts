...
const typeMap: any = {
    "ResponseLocation": o([
        ...
        { json: "base64Encoded", js: "base64Encoded", typ: true },
    ], false),
    "Headers": o([
        { json: "Access-Control-Allow-Origin", js: "Access-Control-Allow-Origin", typ: "" },
        { json: "Access-Control-Allow-Methods", js: "Access-Control-Allow-Methods", typ: "" },
        { json: "Access-Control-Allow-Headers", js: "Access-Control-Allow-Headers", typ: "" },
    ], false),
};
